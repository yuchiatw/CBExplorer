...
class GNet(nn.Module):
    ...
    def forward_part1(self, x):
        ...
        midpoint = len(self.scaleLayers) // 2
        # Upper scales
        for scale, layerGroup in enumerate(self.scaleLayers[:midpoint], 0):
    ...
    def forward_part2(self, x):
        # print('forward part 2')
        midpoint = len(self.scaleLayers) // 2
        # Upper scales
        for scale, layerGroup in enumerate(self.scaleLayers[midpoint:], midpoint):
